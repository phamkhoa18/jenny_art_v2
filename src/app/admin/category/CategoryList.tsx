...
export default function CategoryPage() {
  ...
  const handleOpenCreate = () => {
    ...
    setForm({ name: '', slug: '', isActive: true, link: '' });
    setOpen(true);
  };
  ...
  const handleOpenEdit = (cat: ICategory) => {
    ...
    setForm({
      ...
      link: cat.link || '', // Thêm link vào form khi chỉnh sửa
    });
    setOpen(true);
  };
            ...
            <TableBody>
              {categories.map((cat) => (
                <TableRow key={cat._id} className="hover:bg-gray-50">
                  ...
                  <TableCell>
                    {cat.link ? (
                      <a href={cat.link} className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                        {cat.link}
                      </a>
                    ) : (
                      '-'
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Nhập link (tùy chọn)"
                />
              </div>
